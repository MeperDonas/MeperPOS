...
- `FORM-1`: in progress; commit pending; YAML validation pending.
...
## Next step
Prepare and validate the form locally. Escalate the issue-first bootstrap dependency without direct writes to `master` or fabricated approvals.
